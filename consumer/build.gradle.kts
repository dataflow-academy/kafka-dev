...
dependencies {
    ...
    // Confluent's schemaless JSON serializer and deserializer - a thin
    // Jackson wrapper, no registry.
...
application {
    mainClass = "academy.dataflow.wind.consumer.ConsumerApp"
}

// ./gradlew feed - the ready-made telemetry producer.
tasks.register<JavaExec>("feed") {
    group = "application"
    classpath = sourceSets["main"].runtimeClasspath
    mainClass = "academy.dataflow.wind.consumer.TelemetryFeed"
}

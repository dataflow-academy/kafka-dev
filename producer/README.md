...
the configuration, the producer, the record, the failure branch of the
delivery callback, and a shutdown hook. Everything else — the simulator with
its power curve, the tick loop, logging — is scaffolding and already works.
